...
namespace Microsoft.Xna.Framework.Content
{
    internal class EffectReader : ContentTypeReader<Effect>
    {
		...
		{
			return arr.FirstOrDefault(s => extensions.Any(ext => s.ToLower(System.Globalization.CultureInfo.InvariantCulture) == (search.ToLower(System.Globalization.CultureInfo.InvariantCulture) + ext)));
		}
